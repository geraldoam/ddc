...
<section class="container">
	...
	<div class="p-3 row align-items-start">
		...
		<div class="col-xl-4 p-3">
			<div class="card bg-transparent border-0" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title"><a href="#" class="btn btn-lg btn-block btn-secondary">Português</a></h5>
		...
		<div class="col-xl-4 p-3">
			<div class="card bg-transparent border-0" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title"><a href="#" class="btn btn-lg btn-block btn-secondary">Geografia</a></h5>
		...
		<div class="col-xl-4 p-3">
			<div class="card bg-transparent border-0" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title"><a href="#" class="btn btn-lg btn-block btn-secondary">História</a></h5>
	...
	<div class="p-3 row align-items-start">
		...
		<div class="col-xl-4 p-3">
			<div class="card bg-transparent border-0" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title"><a href="#" class="btn btn-lg btn-block btn-secondary">Filosofia</a></h5>
		...
		<div class="col-xl-4 p-3">
			<div class="card bg-transparent border-0" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title"><a href="#" class="btn btn-lg btn-block btn-secondary">Sociologia</a></h5>
		...
		<div class="col-xl-4 p-3">
			<div class="card bg-transparent border-0" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title"><a href="#" class="btn btn-lg btn-block btn-secondary">Inglês</a></h5>
	...
	<div class="p-3 row align-items-start">
		...
		<div class="col-xl-4 p-3">
			<div class="card bg-transparent border-0" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title"><a href="#" class="btn btn-lg btn-block btn-secondary">Espanhol</a></h5>
		...
		<div class="col-xl-4 p-3">
			<div class="card bg-transparent border-0" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title"><a href="#" class="btn btn-lg btn-block btn-secondary">Artes</a></h5>
...
<section class="container">
	...
	<div class="p-3 row align-items-start">
		...
		<div class="col-xl-4 p-3">
			<div class="card bg-transparent border-0" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title"><a href="#" class="btn btn-lg btn-block btn-secondary">Matemática</a></h5>
		...
		<div class="col-xl-4 p-3">
			<div class="card bg-transparent border-0" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title"><a href="#" class="btn btn-lg btn-block btn-secondary">Química</a></h5>
		...
		<div class="col-xl-4 p-3">
			<div class="card bg-transparent border-0" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title"><a href="#" class="btn btn-lg btn-block btn-secondary">Física</a></h5>
	...
	<div class="p-3 row align-items-start">
		...
		<div class="col-xl-4 p-3">
			<div class="card bg-transparent border-0" style="width: 18rem;">
			  <div class="card-body">
			    <h5 class="card-title"><a href="#" class="btn btn-lg btn-block btn-secondary">Biologia</a></h5>
