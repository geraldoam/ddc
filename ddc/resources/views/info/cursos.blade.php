...
<div class="container">
    ...
    <div class="row featurette" style="margin-top: 80px; margin-bottom: 80px">
      ...
      <div class="col-md-3 p-5">
        <i class="fas fa-flask fa-10x ml-5"></i>
      </div>
    </div>
    ...
    <div class="row featurette" style="margin-top: 80px; margin-bottom: 80px">
      ...
      <div class="col-md-3 p-5">
        <i class="fas fa-book fa-10x ml-5"></i>
      </div>
    </div>
    ...
    <div class="row featurette" style="margin-top: 80px; margin-bottom: 80px">
      ...
      <div class="col-md-3 p-5">
        <i class="fas fa-graduation-cap fa-10x ml-5"></i>
      </div>
    </div>
    ...
    <div class="row featurette" style="margin-top: 80px; margin-bottom: 80px">
      ...
      <div class="col-md-3 p-5">
        <i class="fas fa-book-reader fa-10x ml-5"></i>
      </div>
    </div>
